...
func (b *shStore) RemoveUserFromCompanyInTx(tnx *sql.Tx, user_id, company_id int) error {
...
func (b *shStore) GetUserPermission(u *User, company_id int) (*UserPermission, error) {
